...
namespace _Assets._PlatformSpeciffics.Switch
{
    ...
    public static class NintendoSave
    {

        // Stores the name of the save data mount point. This is like the drive letter.
        // You can change these names if you want.
        private static readonly string _mountName = "MountForklift";
        private static readonly string _fileName = "GameData";
        ...
        private const float minimumDelayBetweenSaves = 5f;
        ...
        //{
        //    Debug.LogError("AGEDEBUG: NXSave Before Scene Load");
        ...
        public static void Initialize()
        {
            ...
            NintendoManager.Initialize();

            // I cache the userId in another script. You can get a reference to it here

            nn.account.Uid userId = NintendoManager.GetUserID();
            nn.Result result;
        ...
        public static string Load(ref bool successful)
        {
        ...
        public static bool Save(string jsonSaveData, bool ignoreFrequencyLimit)
        {
            ...
            bool result = _Save(jsonSaveData, ignoreFrequencyLimit);
        ...
        static bool _Save(string jsonSaveData, bool ignoreFrequencyLimit)
        {
            if (!ignoreFrequencyLimit && !FrequencyIsSafe())
            {
                Debug.Log("Save cancelled due to frequency restriction.");
            ...
            Debug.LogError("AGEDEBUG: Commit result : \n " + result);
