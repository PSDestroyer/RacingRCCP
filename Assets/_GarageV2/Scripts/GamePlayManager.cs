...
public class GamePlayManager : MonoBehaviour
{
    ...
    private void ApplyBaseRacingAISetup(RCCP_RacingOpponentAI racingAI)
    {
        ...
        racingAI.steeringSensitivity = 1.72f;
        racingAI.steeringSmoothTime = .1f;
        racingAI.maxSteerChangePerSecond = 8f;
    ...
    private void ApplyRacingAIDifficulty(RCCP_RacingOpponentAI racingAI, RCCP_AIArcadePreset.Difficulty difficulty)
    {
        switch (difficulty)
        {
            ...
            case RCCP_AIArcadePreset.Difficulty.Hard:
                ...
                racingAI.steeringSensitivity = 1.82f;
                racingAI.steeringSmoothTime = .09f;
                racingAI.maxSteerChangePerSecond = 8.8f;
                racingAI.highSpeedSteerLimit = .92f;
            ...
            case RCCP_AIArcadePreset.Difficulty.Expert:
                ...
                racingAI.steeringSensitivity = 1.9f;
                racingAI.steeringSmoothTime = .085f;
                racingAI.maxSteerChangePerSecond = 9.5f;
                racingAI.highSpeedSteerLimit = .94f;
