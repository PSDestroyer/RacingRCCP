...
namespace Trive.Rendering
{
	...
	{
		[Range(0,1)] public UnityEngine.Rendering.PostProcessing.FloatParameter intensity = new UnityEngine.Rendering.PostProcessing.FloatParameter(){value = 0};
		...
		public UnityEngine.Rendering.PostProcessing.FloatParameter thickness = new UnityEngine.Rendering.PostProcessing.FloatParameter() {value = 0.2f};
		public UnityEngine.Rendering.PostProcessing.FloatParameter screenFadeSize = new UnityEngine.Rendering.PostProcessing.FloatParameter() {value = 0.25f};
		public BoolParameter useFresnel = new BoolParameter() {value = true};
		[Range(0, 1)] public UnityEngine.Rendering.PostProcessing.FloatParameter BRDFBias = new UnityEngine.Rendering.PostProcessing.FloatParameter() {value = 0.7f};
		...
		[Range(0.0f, 1.0f)] public UnityEngine.Rendering.PostProcessing.FloatParameter temporalResponseMin = new UnityEngine.Rendering.PostProcessing.FloatParameter() {value = 0.85f};
		[Range(0.0f, 1.0f)] public UnityEngine.Rendering.PostProcessing.FloatParameter temporalResponseMax = new UnityEngine.Rendering.PostProcessing.FloatParameter() {value = 1f};
		[Header("Debug"), Range(0, 1)] public UnityEngine.Rendering.PostProcessing.FloatParameter smoothnessRange = new UnityEngine.Rendering.PostProcessing.FloatParameter() {value = 1};
	...
	public class StochasticReflectionsRenderer : PostProcessEffectRenderer<StochasticReflections>
	{
		...
		public override void Render(PostProcessRenderContext context)
		{
			...
			context.command.BlitFullscreenTriangle(UnityEngine.Rendering.BuiltinRenderTextureType.None, visibilityTex1, sheet, copyDepthPass);
			var lastDepthPyramid = new UnityEngine.Rendering.RenderTargetIdentifier(visibilityTex1);
			...
			context.command.SetComputeTextureParam(computeShader, raycastKernel, ComputeUniforms.CameraGBufferTexture1, UnityEngine.Rendering.BuiltinRenderTextureType.GBuffer1);
			context.command.SetComputeTextureParam(computeShader, raycastKernel, ComputeUniforms.CameraGBufferTexture2, UnityEngine.Rendering.BuiltinRenderTextureType.GBuffer2);
			...
			if (settings.useMipMap)
			{
				...
				var last = new UnityEngine.Rendering.RenderTargetIdentifier(mainBuffer);
			...
			context.command.SetComputeTextureParam(computeShader, resolveKernel, ComputeUniforms.CameraGBufferTexture1, UnityEngine.Rendering.BuiltinRenderTextureType.GBuffer1);
			context.command.SetComputeTextureParam(computeShader, resolveKernel, ComputeUniforms.CameraGBufferTexture2, UnityEngine.Rendering.BuiltinRenderTextureType.GBuffer2);
			context.command.SetComputeTextureParam(computeShader, resolveKernel, ComputeUniforms.CameraMotionVectorsTexture, UnityEngine.Rendering.BuiltinRenderTextureType.MotionVectors);
			...
			var finalResolve = new UnityEngine.Rendering.RenderTargetIdentifier(resolvePassTex);
			...
			if (settings.useTemporal && !context.isSceneView)
			{
				...
				context.command.SetComputeTextureParam(computeShader, temporalKernel, ComputeUniforms.CameraMotionVectorsTexture, UnityEngine.Rendering.BuiltinRenderTextureType.MotionVectors);
				context.command.SetComputeTextureParam(computeShader, temporalKernel, ComputeUniforms.CameraDepthTexture, UnityEngine.Rendering.BuiltinRenderTextureType.ResolvedDepth);
		...
		public static void BlitFullscreenTriangle(UnityEngine.Rendering.CommandBuffer cmd, UnityEngine.Rendering.RenderTargetIdentifier source, UnityEngine.Rendering.RenderTargetIdentifier destination, Material material, int pass, bool clear = false)
		{
